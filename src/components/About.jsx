...
const About = () => {
  ...
  return (
    ...
    <div className="container mx-auto px-6 py-10 pt-20">
      ...
      <p className="text-lg mb-4">Our state-of-the-art facilities feature cutting-edge laboratories equipped with the latest technology and resources, allowing students to conduct experiments and explore scientific concepts in a hands-on manner. Our experienced faculty members are experts in their respective fields and are dedicated to nurturing each student's unique talents and interests.</p>
      <p className="text-lg mb-4">Superior Science Academy offers a comprehensive range of programs, including:</p>
      <ul className="list-disc pl-6 mb-4">
        <li>STEM enrichment courses</li>
        <li>Advanced placement (AP) science classes</li>
        <li>Science Olympiad teams</li>
        <li>Science summer camps</li>
