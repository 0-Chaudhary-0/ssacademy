...
function Enroll() {
  ...
  const handleSubmit = async (e) => {
    ...
    isDisable.current.classList.remove("bg-blue-500");
    isDisable.current.classList.add("bg-blue-200");
    setProgress(30);
    ...
    if (content.success) {
      ...
      isDisable.current.classList.remove("bg-blue-200");
      isDisable.current.classList.add("bg-blue-500");
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mt-4">
                <button
                  ref={isDisable}
                  type="submit"
                  className="bg-blue-500 ml-6 text-white px-4 py-2 rounded focus:outline-none"
                >
                  Submit
                </button>
              </div>
      ...
      {isEnrolled && (
        <div className="my-40">
          ...
          <p className="text-center">
            <Link className="text-gray-500 hover:text-black" to="/">
              Back to Lobby
            </Link>
          </p>
        </div>
